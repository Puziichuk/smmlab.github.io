...
<div className="why">
	<ul>
		<li>С 2012 года мы занимаемся исключительно продвижением бизнеса в социальных сетях и знаем об этом всё</li>
		<li>Мы предоставляем полный комплекс услуг: от разработки стратегии продвижения до публикации рекламных постов на страницах лидеров мнения</li>
		<li>Гарантируем самую оперативную обратную связь любым удобным для вас способом</li>
	</ul>
</div>
</div>
<div className="row">
...
<div className="container">
			<div className="row">
				<div className="col-md-3">
					<div className="social">
						<a href="">
							<img src="images/si1.png"></img>	
						</a>
						<a href="">
							<img src="images/icon (5).png"></img>
						</a>	
				</div>
				<div className="services1">
				<ul>
				<li><a href="">Продвижение вашей старницы в ВКонтакте</a></li>
				</ul>
			</div>
		</div>
			<div className="row">
				...
				<ul>
				<li><a href="">Продвижение вашей старницы в Facebook</a></li>
				</ul>
					</div>	
			</div>
			<div className="row">
				...
				<div className="services">
				<ul>
				<li><a href="">Продвижение вашей старницы в Одноклассники</a></li>
				</ul>
					</div>	
			</div>
			<div className="row">
				...
				<div className="services">
				<ul>
				<li><a href="">Продвижение вашей старницы в Instagram</a></li>
				</ul>
				</div>	
			</div>
			</div>
			...
			<div className="row">
				<div className="col-md-5">
					<div className="tl">
						...
						<a href=""><img src="images/icon (5).png"></img></a>		
					</div>
						<div className="name9">
						<ul>
						<li>от 90 до 190 $</li>
...
<p>в свой бизнес!</p>
			...
			<div className="row">
				<div className="col-md-5">
					<div className="t2">
						<a href=""><img src="images/c2.png"></img></a>
				</div>
